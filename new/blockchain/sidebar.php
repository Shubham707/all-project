				...
				<div class="row">
					<div class="col-sm-3" >
						...
						<!-- <h4>Be your own bank.®</h4> -->
							<div class="row col-md-2 side_left">
								...
								<button class="btn btn-info" onclick="document.getElementById('id04').style.display='block'"><div class="large">
									<em class="fa fa-send"></em></div>
								<div class="text-muted"></div>SEND</button>

								<?php } else { ?>
								<button class="btn btn-info" onclick="alert('Verify Email Id');">
									<div class="large">
									<em class="fa fa-send"></em></div>
								<div class="text-muted"></div>SEND</button>
								<?php } ?>
							...
							<div class="row col-md-2 side_right">
								<button class="btn btn-info" style="color: white;" onclick="document.getElementById('id05').style.display='block'"><div class="large"><em class="fa fa-send rotate"></em></div>
				   ...
				   <div class="col-sm-6">
				      <div class="panel panel-teal panel-widget side_right_side">
							...
							?>
								<div class="large"><?php echo @$user_current_balance." " . @$coin_short;?></div>
							</div>
				       </div>
				  </div>
			</div>
