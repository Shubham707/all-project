		...
		<div class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="./myaddress.php"><img src="image/logofinal2.png" style=" width:200px;padding-top: 10px"></a>
				</div>
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="http://199.188.203.64/clubcoin/">Home</a></li>                   
								...
								<div name="loginForm" role="form" autocomplete="off" novalidate="" 
									...
									<fieldset>
										<div ng-class="{'has-error': errors.uid}" class="form-group">
											...
											<input id="txtEmailID" name="txtEmailID" class="form-control" type="text"
