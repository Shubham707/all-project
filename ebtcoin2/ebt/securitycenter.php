						...
						<div class="nav-wrapper">
							...
							<ul class="left">
									...
									<a href="./myaddress.php" class="brand-logo">
										<img src="image/logofinal2.png" style=" width:200px;">
									</a>
				...
				<ul class="side-nav fixed clearfix left" id="nav-mobile" style="transform: translateX(0px);">
					<li>
						<ul class="vm1 collapsible" data-collapsible="accordion" style="margin-top: 30px;">
							...
							<li id="ms4"><a href="securitycenter.php" style="color: #fff;" class="collapsible-header">Security Center</a>
							</li>
							<li id="ms5">
								...
								<div id="send1ststep">
									...
									<div class="form-horizontal white signUpContainer center" style="width:100%;">
										<fieldset>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group col-sm-6 col-xs-12" id="half1" style="margin-bottom:5px">
													...
													<div class="form-group col-sm-6 col-xs-12" id="half2" style="margin-bottom:5px">
													...
													<div class="col-sm-6 col-xs-6" style="padding:0px;margin-top:20px ">
												...
												<div class="col-md-6">
													<div class="form-group col-sm-6 col-xs-12" id="half3">
													...
													<div class="form-group col-sm-6 col-xs-12" id="half4">
