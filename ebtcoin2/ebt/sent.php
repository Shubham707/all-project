	...
	<body>
		<div class="wrapper vertical-sidebar" id="full-page">
			...
			<div id="mySidenav" class="sidenav-mobile">
			  ...
			  <a href="http://clubcoin.co/">Home</a>
				...
				<ul class="side-nav fixed clearfix left" id="nav-mobile" style="transform: translateX(0px);">
					<li>
						<ul class="vm1 collapsible" data-collapsible="accordion" style="margin-top: 30px;">
							<li id="ms1"><a href="http://clubcoin.co/" class="collapsible-header"><!--<i class="zmdi zmdi-home zmdi-hc-fw iconhome"></i>-->Home</a></li>
							<li id="ms2" class="active"><a href="transactions.php" style="color: #fff;" class="collapsible-header"><!--<i class="zmdi zmdi-swap-vertical icontransaction" style="font-size:30px;"></i>-->Transactions</a></li>
