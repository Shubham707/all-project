		...
		<div class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="" ><img src="image/logofinal2.png" style=" width:150px"></a>
				</div>
								...
								<div name="loginForm" role="form" autocomplete="off" novalidate="" 
									...
									<fieldset>
										<div ng-class="{'has-error': errors.uid}" class="form-group">
											...
											<input id="txtEmailID" name="txtEmailID" class="form-control" style="border:2px solid #dd9933;" type="text"
											value="">
											
										</div>
										<div ng-class="{'has-error': errors.password}" class="form-group">
											<label style="float:left">Password</label>
											<input id="txtpassword" name="txtpassword" class="form-control" style="border:2px solid #dd9933;" type="password" value="">
