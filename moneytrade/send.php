				...
				<div id="page-content">
					<div class="row section-header">
						<div class="col l12" id="topvalues">
							<div style="overflow:hidden;cursor:pointer;"><h5 id="lblbtcbalancesmall" class="topbtc"></h5></div>
							...
							<div style="overflow:hidden;cursor:pointer;"><h6 id="lblbtcbalance2small" class="topusd" style="display: none;"></h6></div>
						</div>
						...
						<div class="col m6 l6" id="sidetopvalues">
							<div style="overflow:hidden;cursor:pointer;"><h5 id="lblbtcbalance" class="topbtc"></h5></div>
							...
							<div style="overflow:hidden;cursor:pointer;"><h6 id="lblbtcbalance2" class="topusd" style="display: none;"></h6></div>
						</div>
					</div>
				</div>
			</main>
								...
								<div id="send1ststep">
									<div class="modal-head">
										<div class="col l8">
											...
											<p>Instantly send to any address.</p>
                        </div>
										...
										<div name="loginForm" role="form" autocomplete="off" novalidate="" 
											...
											<fieldset>
												<div  class="form-group">
													...
													placeholder="Paste your  Address" autocomplete="off" type="text"
													value="">
												...
												<div  class="form-group">
													...
													name="txtChar" type="text" value ="">
													
												</div>
												
												<div class="form-group">
													<label style="float:left">Description</label>
													<textarea id="discription" name ="discription" type="text" class="validate" placeholder="Description" style="position:relative;padding: 10px;height: 4rem;font-size:14px;resize: none;-ms-overflow-style: none;border:1px solid #9e9e9e;"></textarea>
												</div>
												<div  class="form-group">
