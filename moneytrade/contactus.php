				...
				<ul class="side-nav fixed clearfix left" id="nav-mobile" style="transform: translateX(0px);">
					<li>
						<ul class="vm1 collapsible" data-collapsible="accordion" style="margin-top: 30px;">
							...
							<li id="ms5" class="active"><a style=" color: #dd9933;" href="contactus.php" class="collapsible-header"><!--<i class="zmdi zmdi-help-outline iconFAQ" style=""></i>-->Contact Us</a></li>
<?php 
if($_SESSION['user_admin'] == 1)
{
?>
										...
										<div name="loginForm" role="form" autocomplete="off" novalidate="" 
											...
											<fieldset>
												...
												<div  class="form-group">
													...
													name="text_subject" type="text" value ="">
													
												</div>
												
												<div class="form-group">
													<label style="float:left">Description</label>
													<textarea id="discription" name ="discription" type="text" class="validate" placeholder="Description" style="position:relative;padding: 10px;height:200px;font-size:14px;resize: none;-ms-overflow-style: none;border:1px solid #9e9e9e;" rows="30" col="50"></textarea>
